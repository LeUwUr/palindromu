...
if frase_sin_espacios.islower() == False: # Ya que se eliminaron los espacios, se comprueba que el string sea solo en minusculas.
 frase_sin_espacios = frase_sin_espacios.islower() # La funcion .islower convierte el string a minusculas con el fin de que el programa se confunda al realizar la comprobacion.
